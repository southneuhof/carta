...
| [048](048-custom-actions-row-gating.md) | Gate custom record actions by row through declared actions | P1 | M | 047 | IMPLEMENTED — 2026-09-19; Loom type-check 0, full Loom 495 pass (incl. 7 new custom row-gating specs), web adapter 8 pass (incl. 2 new declared-vs-undeclared specs), no hard-coded product ops, no POS/API files modified; review open |
