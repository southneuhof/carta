...
- `plans/implementation-evidence/: compiler measurement logs and type-surface inventory`
...
form.submit // required; no non-null assertion

const rowForm = defineForm({ schema: rowSchema, fields: rowInputs })
// No submit member is introduced by construction.
```
