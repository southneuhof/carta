...
export default defineConfig({
  ...
  test: {
    include: ['src/components/core/__tests__/Table.browser.spec.ts', 'src/components/core/__tests__/TreeTable.browser.spec.ts', 'src/components/core/__tests__/DisplayParity.browser.spec.ts', 'src/components/views/__tests__/ListView.browser.spec.ts', 'src/components/base/__tests__/primitives.browser.spec.ts', 'src/components/inputs/__tests__/FileInput.browser.spec.ts', 'src/components/inputs/__tests__/SelectInput.browser.spec.ts', 'src/components/composites/__tests__/LookupInput.browser.spec.ts', 'src/components/inputs/__tests__/DateInput.browser.spec.ts', 'src/components/composites/__tests__/SurfaceParity.browser.spec.ts'],
    browser: {
      enabled: true,
      headless: true,
      provider: playwright(),
