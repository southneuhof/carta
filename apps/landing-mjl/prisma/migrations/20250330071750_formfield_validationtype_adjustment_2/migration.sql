/*
  ...
  - The values [text] on the enum `FormFieldValidationType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "FormFieldValidationType_new" AS ENUM ('email', 'phone', 'number', 'url', 'date', 'file');
