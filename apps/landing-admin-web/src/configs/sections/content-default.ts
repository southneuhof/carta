import schema from '@southneuhof/landing-section-schema/sections/content-default'
...
export default defineSectionEditorOverlay(schema, {
  ...
  slots: {
    content: {
      label: 'Main Content',
      fields: ['media_type', 'media', 'attachment', 'subtitle', 'title', 'description', 'url', 'url_text'],
      inputConfig: {
        media_type: {
          type: 'radio',
          props: {
