...
const DetailRoute = (await import('./detail.route.vue')).default
...
async function mountRoute() {
  const router = createRouter({
    ...
    routes: [
      { path: '/hr/overtimes/:overtimeId/detail', name: 'hr-overtimes-detail', component: DetailRoute },
      { path: '/hr/overtimes/:overtimeId/edit', name: 'hr-overtimes-edit', component: { template: '<div />' } },
      { path: '/hr/overtimes', name: 'hr-overtimes', component: { template: '<div />' } },
    ],
  })
  await router.push('/hr/overtimes/o1/detail')
