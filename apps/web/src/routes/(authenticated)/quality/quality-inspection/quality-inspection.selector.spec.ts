...
const node = (id: string, parentId: string | null, children: QualityInspectionTreeNode[] = [], itps: QualityInspectionTreeNode['itps'] = []): QualityInspectionTreeNode => ({ id, projectId: 'project-1', parentId, level: parentId ? 1 : 0, code: id, name: id, isLeaf: !children.length, itps, children })
