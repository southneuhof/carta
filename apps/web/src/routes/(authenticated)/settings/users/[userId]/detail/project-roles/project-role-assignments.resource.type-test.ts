...
const options: ProjectRoleAssignmentOptions = {
  divisions: [{ id: 'division-1', name: 'Division 1', active: true }],
  projects: [{ id: 'project-1', divisionId: 'division-1', number: 'P-1', name: 'Project 1', active: true }],
}
const coverages: ProjectRoleCoverage[] = [{ coverageType: 'all_projects' }, { coverageType: 'division', divisionId: 'division-1' }, { coverageType: 'project', projectId: 'project-1' }]
