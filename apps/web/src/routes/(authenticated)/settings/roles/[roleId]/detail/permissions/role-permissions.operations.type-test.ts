...
const row: Permission = { id: 'permission-1', permissionCode: 'manage-roles', name: 'Manage roles', description: null, module: { id: 'module-1', code: 'roles', name: 'Roles', realm: 'system' }, assigned: true }
