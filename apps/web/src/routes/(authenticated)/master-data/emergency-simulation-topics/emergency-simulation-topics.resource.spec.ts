...
describe('Topik Simulasi Tanggap Darurat resource', () => {
  ...
  it('maps standard CRUD routes', () => {
    ...
    expect(resourceActionForRoute('master-data-emergency-simulation-topics')).toMatchObject({
      resourceKey: 'emergency-simulation-topics',
      action: 'list',
      permission: 'view-emergency-simulation-topics',
    })
    expect(resourceActionForRoute('master-data-emergency-simulation-topics-detail')).toMatchObject({
      resourceKey: 'emergency-simulation-topics',
      action: 'detail',
      permission: 'view-emergency-simulation-topics',
    })
    expect(resourceActionForRoute('master-data-emergency-simulation-topics-create')).toMatchObject({
      resourceKey: 'emergency-simulation-topics',
      action: 'create',
      permission: 'create-emergency-simulation-topics',
    })
    expect(resourceActionForRoute('master-data-emergency-simulation-topics-edit')).toMatchObject({
      resourceKey: 'emergency-simulation-topics',
      action: 'update',
