 ...
 */
import { ref } from 'vue'
import { defineFields, defineResource, defineSchema, Form, Table } from '@southneuhof/is-vue-framework'
import type { FieldsInput, WebResourceSchema } from '@southneuhof/is-vue-framework'
