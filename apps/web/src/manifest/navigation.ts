...
export const navigation = defineNavigation([
  ...
  { name: 'quality', title: 'Quality', icon: 'folder', description: 'Quality work', routes: [{ action: pts.capabilities.list!, title: 'PTS', icon: 'folder' }] },
  {
    ...
    routes: [
      { to: { name: 'master-data-business-categories' }, permission: 'view-business-categories', title: 'Business Categories', icon: 'folder' },
      { to: { name: 'master-data-divisions' }, permission: 'view-divisions', title: 'Divisions', icon: 'folder' },
      { to: { name: 'master-data-projects' }, permission: 'view-projects', title: 'Projects', icon: 'folder' },
      { to: { name: 'master-data-uoms' }, permission: 'view-uoms', title: 'UOMs', icon: 'folder' },
      { to: { name: 'master-data-work-items' }, permission: 'view-work-items', title: 'Work Items', icon: 'folder' },
      { to: { name: 'master-data-project-vendors' }, permission: 'view-project-vendors', title: 'Project Vendors', icon: 'folder' },
      { to: { name: 'master-data-pts-work-categories' }, permission: 'view-pts-work-categories', title: 'PTS Work Categories', icon: 'folder' },
      { to: { name: 'master-data-root-causes' }, permission: 'view-root-causes', title: 'Root Causes', icon: 'folder' },
      { to: { name: 'master-data-number-variables' }, permission: 'view-number-variables', title: 'Number Variables', icon: 'folder' },
