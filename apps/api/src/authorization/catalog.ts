...
export const authorizationModules = [
  ...
  {
    code: "law-reference-items",
    name: "Law Reference Items",
    realm: "system",
    active: true,
    permissions: [
      { code: "view-law-reference-items", name: "View Law Reference Items", description: "View law reference items.", active: true },
      { code: "list-law-reference-items", name: "List Law Reference Items", description: "List law reference items.", active: true },
      { code: "detail-law-reference-items", name: "Detail Law Reference Items", description: "View a law reference item.", active: true },
      { code: "create-law-reference-items", name: "Create Law Reference Items", description: "Create law reference items.", active: true },
      { code: "update-law-reference-items", name: "Update Law Reference Items", description: "Update law reference items.", active: true },
      { code: "delete-law-reference-items", name: "Delete Law Reference Items", description: "Delete law reference items.", active: true },
    ],
  },
  {
    code: "hsse-observation",
    name: "HSSE Observation",
    realm: "system",
    active: true,
    permissions: [
      { code: "view-hsse-observation", name: "View HSSE Observation", description: "View the HSSE observation master.", active: true },
    ],
  },
  {
    ...
    active: true,
    permissions: [
      { code: "view-finding-criteria", name: "View Finding Criteria", description: "View finding criteria.", active: true },
      { code: "list-finding-criteria", name: "List Finding Criteria", description: "List finding criteria.", active: true },
      { code: "detail-finding-criteria", name: "Detail Finding Criteria", description: "View a finding criterion.", active: true },
      { code: "create-finding-criteria", name: "Create Finding Criteria", description: "Create finding criteria.", active: true },
      { code: "update-finding-criteria", name: "Update Finding Criteria", description: "Update finding criteria.", active: true },
      { code: "delete-finding-criteria", name: "Delete Finding Criteria", description: "Delete finding criteria.", active: true },
    ],
  },
  {
    code: "finding-types",
    ...
    active: true,
    permissions: [
      { code: "view-finding-types", name: "View Finding Types", description: "View finding types.", active: true },
      { code: "list-finding-types", name: "List Finding Types", description: "List finding types.", active: true },
      { code: "detail-finding-types", name: "Detail Finding Types", description: "View a finding type.", active: true },
      { code: "create-finding-types", name: "Create Finding Types", description: "Create finding types.", active: true },
      { code: "update-finding-types", name: "Update Finding Types", description: "Update finding types.", active: true },
      { code: "delete-finding-types", name: "Delete Finding Types", description: "Delete finding types.", active: true },
    ],
  },
  {
    code: "finding-categories",
    name: "Finding Categories",
    realm: "system",
    active: true,
    permissions: [
      { code: "view-finding-categories", name: "View Finding Categories", description: "View finding categories.", active: true },
      { code: "list-finding-categories", name: "List Finding Categories", description: "List finding categories.", active: true },
      { code: "detail-finding-categories", name: "Detail Finding Categories", description: "View a finding category.", active: true },
      { code: "create-finding-categories", name: "Create Finding Categories", description: "Create finding categories.", active: true },
      { code: "update-finding-categories", name: "Update Finding Categories", description: "Update finding categories.", active: true },
      { code: "delete-finding-categories", name: "Delete Finding Categories", description: "Delete finding categories.", active: true },
    ],
  },
  {
    code: "finding-cause",
    ...
    active: true,
    permissions: [
      { code: "view-finding-cause", name: "View Finding Cause", description: "View finding causes.", active: true },
      { code: "list-finding-cause", name: "List Finding Cause", description: "List finding causes.", active: true },
      { code: "detail-finding-cause", name: "Detail Finding Cause", description: "View a finding cause.", active: true },
      { code: "create-finding-cause", name: "Create Finding Cause", description: "Create finding causes.", active: true },
      { code: "update-finding-cause", name: "Update Finding Cause", description: "Update finding causes.", active: true },
      { code: "delete-finding-cause", name: "Delete Finding Cause", description: "Delete finding causes.", active: true },
    ],
  },
  {
    code: "incident-statement-document-configs",
    name: "Incident Statement Document Configs",
    realm: "system",
    active: true,
    permissions: [
      { code: "view-incident-statement-document-configs", name: "View Incident Statement Document Configs", description: "View incident statement document configs.", active: true },
      { code: "list-incident-statement-document-configs", name: "List Incident Statement Document Configs", description: "List incident statement document configs.", active: true },
      { code: "detail-incident-statement-document-configs", name: "Detail Incident Statement Document Configs", description: "View an incident statement document config.", active: true },
      { code: "create-incident-statement-document-configs", name: "Create Incident Statement Document Configs", description: "Create incident statement document configs.", active: true },
      { code: "update-incident-statement-document-configs", name: "Update Incident Statement Document Configs", description: "Update incident statement document configs.", active: true },
      { code: "delete-incident-statement-document-configs", name: "Delete Incident Statement Document Configs", description: "Delete incident statement document configs.", active: true },
    ],
  },
  {
  ...
  },
  {
    ...
    active: true,
    permissions: [
      { code: "view-syllabus", name: "View Syllabus", description: "View syllabus records.", active: true },
      { code: "list-syllabus", name: "List Syllabus", description: "List syllabus records.", active: true },
      { code: "detail-syllabus", name: "Detail Syllabus", description: "View a syllabus record.", active: true },
      { code: "create-syllabus", name: "Create Syllabus", description: "Create syllabus records.", active: true },
      { code: "update-syllabus", name: "Update Syllabus", description: "Update syllabus records.", active: true },
      { code: "delete-syllabus", name: "Delete Syllabus", description: "Delete syllabus records.", active: true },
    ],
  },
  {
    code: "syllabus-categories",
    name: "Syllabus Categories",
    realm: "system",
    active: true,
    permissions: [
      { code: "view-syllabus-categories", name: "View Syllabus Categories", description: "View syllabus category records.", active: true },
      { code: "list-syllabus-categories", name: "List Syllabus Categories", description: "List syllabus category records.", active: true },
      { code: "detail-syllabus-categories", name: "Detail Syllabus Categories", description: "View a syllabus category record.", active: true },
      { code: "create-syllabus-categories", name: "Create Syllabus Categories", description: "Create syllabus category records.", active: true },
      { code: "update-syllabus-categories", name: "Update Syllabus Categories", description: "Update syllabus category records.", active: true },
      { code: "delete-syllabus-categories", name: "Delete Syllabus Categories", description: "Delete syllabus category records.", active: true },
    ],
  },
  {
    ...
    active: true,
    permissions: [
      { code: "view-learning-materials", name: "View Learning Materials", description: "View learning material records.", active: true },
      { code: "list-learning-materials", name: "List Learning Materials", description: "List learning material records.", active: true },
      { code: "detail-learning-materials", name: "Detail Learning Materials", description: "View a learning material record.", active: true },
      { code: "create-learning-materials", name: "Create Learning Materials", description: "Create learning material records.", active: true },
      { code: "update-learning-materials", name: "Update Learning Materials", description: "Update learning material records.", active: true },
      { code: "delete-learning-materials", name: "Delete Learning Materials", description: "Delete learning material records.", active: true },
    ],
  },
